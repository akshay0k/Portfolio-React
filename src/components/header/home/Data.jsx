...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className='home__title'>Akshay K
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description"> I'm a Mern stack developer based in Bangalore, and i'm very passionate and dedicated to mywork. </p>
